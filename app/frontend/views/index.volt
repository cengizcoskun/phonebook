                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="header-collapse">
                        <ul class="nav navbar-nav">
                            <li>{{ linkTo('', '<span class="glyphicon glyphicon-home"></span> ' ~ __('Home')) }}</li>
                            <li>{{ linkTo('#', '<span class="glyphicon glyphicon-info-sign"></span> ' ~ __('About Us')) }}</li>
                            <li>{{ linkTo('contact', '<span class="glyphicon glyphicon-phone"></span> ' ~ __('Contact')) }}</li>
                        </ul>
                        {% if ! auth.logged_in() %}
